...
public class AudioServiceController implements IAudioPlayerControl {
    ...
    private static Handler mHandlerbindAudioServiceConnected;
    ...
    public void setHandlerbindAudioServiceConnected(Handler h){
    	mHandlerbindAudioServiceConnected = h;
    }
        ...
        if (!mIsBound) {
            ...
            mAudioServiceConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    ...
                    //向界面发送Msg
                    if(mHandlerbindAudioServiceConnected != null){
                    	mHandlerbindAudioServiceConnected.sendEmptyMessage(0);
                    }
                }
            };
    ...
    public void unbindAudioService(Context context) {
        if (context == null) {
            Log.i("zjj", "AudioServiceController unbindAudioService() with null Context. Ooops" );
            return;
        }
        context = context.getApplicationContext();
        ...
        if (mIsBound) {
            ...
            try {
                ...
                Log.e("zjj", "AudioServiceController remote procedure call failed: removeAudioCallback()");
            }
            context.unbindService(mAudioServiceConnection);
            mAudioServiceBinder = null;
            mAudioServiceConnection = null;
            
            Log.i("zjj", "AudioServiceController unbindAudioService");
        }
    }
    ...
    private <T> T remoteProcedureCall(IAudioService instance, Class<T> returnType, T defaultValue, String functionName, Class<?> parameterTypes[], Object parameters[]) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.i("zjj","VLC AudioService Exception:" + e.toString());
            return defaultValue;
