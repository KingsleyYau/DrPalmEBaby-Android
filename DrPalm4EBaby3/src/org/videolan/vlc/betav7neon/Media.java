...
public class Media implements Comparable<Media> {
    ...
    public Media(String URI, Boolean addToDb) {
        ...
        if (addToDb) {
            ...
            MediaDatabase db = MediaDatabase.getInstance(GlobalVariables.gAppContext);
            db.addMedia(this);
        }
    }
    ...
    public Bitmap getPicture() {
        ...
        if (mPicture == null) {
            ...
            if (picture == null) {
                 ...
                 */
                Context c = GlobalVariables.gAppContext;
                picture = MediaDatabase.getInstance(c).getPicture(c, mLocation);
                cache.addCacheBitmap(picture, mLocation);
            }
            return picture;
        } else {
            return mPicture;
    ...
    public String getGenre() {
        if(mGenre == GlobalVariables.gAppContext.getString(R.string.unknown_genre))
            return mGenre;
