...
package org.videolan.vlc.betav7neon.video;
...
import org.videolan.vlc.betav7neon.gui.PreferencesActivity;
import org.videolan.vlc.betav7neon.interfaces.IPlayerControl;
import org.videolan.vlc.betav7neon.interfaces.OnPlayerControlListener;
import org.videolan.vlc.betav7neon.widget.PlayerControlClassic;
import org.videolan.vlc.betav7neon.widget.PlayerControlWheel;
...
public class VideoPlayerActivity extends Activity implements IVideoPlayer {
    ...
    private static final int FINISHEDDOWN = 3;// 下载所有完成的标签
...
//    private boolean isVideo = true;	//是否视频
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("zjj", "VideoPlayerActivity onCreate");
        ...
        //封面
        mProgressBarLoading = (ProgressBar)findViewById(R.id.PB_vlc_loading);
        ...
        filter.addAction(GlobalVariables.SLEEP_INTENT);
    ...
    protected void onStart() {
        ...
        Log.i("zjj", "VideoPlayerActivity onStart");
    ...
    protected void onPause() {
    	super.onPause();
        Log.i("zjj", "VideoPlayerActivity onPause");
        
//        if(mSwitchingView) {
//            Log.i("zjj", "mLocation = \"" + mLocation + "\"");
...
//        }
        ...
        Log.i("zjj", "mSurface.setKeepScreenOn(false);" );
...
//        editor.commit();
//        
//        Log.i("zjj", "editor.commit();" );
//        
//        AudioServiceController.getInstance().unbindAudioService(this);
//        
//        Log.i("zjj", "unbindAudioService(this)" );
    ...
    protected void onStop() {
        super.onStop();
        Log.i("zjj", "VideoPlayerActivity onStop");
    }

    @Override
    protected void onDestroy() {
    	super.onDestroy();
        Log.i("zjj", "VideoPlayerActivity onDestroy");
        
        unregisterReceiver(mReceiver);
        Log.i("zjj", "VideoPlayerActivity unregisterReceiver");
        
        if (mLibVLC != null && !mSwitchingView) {
//        	if(mLibVLC.isPlaying()){
        		Log.i("zjj", "VideoPlayerActivity mLibVLC.stop()1");
				mLibVLC.stop();
	            Log.i("zjj", "VideoPlayerActivity mLibVLC.stop()2");
//        	}
        }

        try{
        	Log.i("zjj", "VideoPlayerActivity removeHandler");
        	EventHandler em = EventHandler.getInstance();
            em.removeHandler(eventHandler);
        }catch(Exception e){
        	Log.i("zjj",e.toString());
        }
    ...
    protected void onResume() {
        super.onResume();
        Log.i("zjj", "VideoPlayerActivity onResume");
        
//        AudioServiceController.getInstance().bindAudioService(this);
//        Log.i("zjj", "VideoPlayerActivity bindAudioService");
        
        
        load();
        Log.i("zjj", "VideoPlayerActivity load()");
...
//            }}, 500);
        ...
        showOverlay();
        Log.i("zjj", "VideoPlayerActivity showOverlay()");

        // Add any selected subtitle file from the file picker
//        if(mSubtitleSelectedFiles.size() > 0) {
//            for(String file : mSubtitleSelectedFiles) {
//                Log.i("zjj", "VideoPlayActivity Adding user-selected subtitle " + file);
...
//        	Log.i("zjj", "VideoPlayerActivity start() intent.addFlags");
        }
//        else {
//            // Stop the currently running audio
//            AudioServiceController asc = AudioServiceController.getInstance();
//            asc.stop();
//            Log.i("zjj", "VideoPlayerActivity start() asc.stop()");
//        }
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            else if (action.equalsIgnoreCase(GlobalVariables.SLEEP_INTENT)) {
                finish();
            }
        }
    };
...
//                    Log.i("zjj", "VideoPlayerActivity SHOW_PROGRESS");
                    break;
                case SURFACE_SIZE:
    ...
    private final OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            if (fromUser) {
//            	Log.i("zjj", "VideoPlayerActivity mSeekListener onProgressChanged");
            	Log.i(TAG, "mSeekListener onProgressChanged");
            	showProgressbar();
    ...
    */
    ...
    private void dimStatusBar(boolean dim) {
        ...
        if (!Util.hasCombBar() && Util.isJellyBeanOrLater())
            layout = View.SYSTEM_UI_FLAG_HIDE_NAVIGATION;// .SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_LAYOUT_STABLE;
...
//        Log.i("zjj", "VideoPlay load:mLocation:" + mLocation);
...
//        mTitle.setText(title);
		...
		try {
			...
			if(mLibVLC != null) {
				...
				mUrlPerview = getIntent().getStringExtra("url");
//				String pathUri = LibVLC.getInstance().nativeToURI(path);
//				isVideo = mLibVLC.hasVideoTrack(path);
...
//			fileName = "image" + String.valueOf(mEventid) + "_" + url.substring(url.lastIndexOf("."), url.length());
//		}else{
//			fileName = "image" + String.valueOf(mEventid) + "_jpg";
//		}
//		
//		Log.i("zjj", "视频相册 url:"  + url + ",fileName:" + fileName);
//		mImageLoader.loadFile(url, false, fileName, new FileCallback() {
//
//			@Override
//			public void fileLoaded(boolean isDone) {
//					Message msg = new Message();
//					msg.what = FINISHEDDOWN;
//					mHandlerPerview.sendMessage(msg);
//				}
//		});
//	}
//	
//	private Handler mHandlerPerview = new Handler() {
//		public void handleMessage(Message msg) {
//			switch (msg.what) {
//			case FINISHEDDOWN:
...
//			Log.i("zjj","VideoPlayerActivity mVideoVisibleHeight:" + mVideoVisibleHeight);
			
			if( mVideoVisibleHeight != 0 ){
