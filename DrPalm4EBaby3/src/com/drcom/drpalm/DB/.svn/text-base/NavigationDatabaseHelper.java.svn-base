...
public class NavigationDatabaseHelper extends SQLiteOpenHelper {
	...
	private static NavigationDatabaseHelper databaseHelperInstent ;
	...
	private NavigationDatabaseHelper(Context context) {
		super(context, DATABASE_NAME, null, DATABASE_VERSION);
	}

	public static NavigationDatabaseHelper getInstance(Context context) {
		if(databaseHelperInstent == null) {
			databaseHelperInstent = new NavigationDatabaseHelper(GlobalVariables.gAppContext);
