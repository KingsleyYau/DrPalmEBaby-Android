...
package com.drcom.drpalm.View.controls.wheel;
...
public class WheelView extends View {
	...
	/** Text size */
	private int TEXT_SIZE_DP = 18; //(dp)
	...
	private void initData(Context context) {
		...
		TEXT_SIZE = (int)( TEXT_SIZE_DP * (double)context.getResources().getDisplayMetrics().densityDpi/160);
	 ...
	 * @param str
	 */
	public void Scroll2TheSameItem(String str){
		for(int i = 0 ; i < adapter.getItemsCount(); i ++){
			if(getTextItem(i).equals(str)){
