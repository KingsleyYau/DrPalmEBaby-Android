...
public class MultiDirectionSlidingDrawer extends ViewGroup {
	...
	// MeasureSpec.UNSPECIFIED ) { throw new RuntimeException(
...
//		if (action == MotionEvent.ACTION_MOVE) {	//要使手柄的子控件有事件,使用这句,但响应不太灵敏
...
//		}
	...
	public int getDrawerHeight1() {
		return mHandleHeight;
	}

	public int getDrawerHeight2() {
