...
public class ImageUntil {
	...
	public static final String IMAGE_COMPRESS_CACHE_PATH = SDCARD + GlobalVariables.ROOTPATH + "/compressImageTemp/";	//压缩后图片保存路径
	public static final String IMAGE_CACHE_PATH = SDCARD + GlobalVariables.ROOTPATH + "/imageTemp/";	//拍照原图保存路径
...
//		Log.i("lch", "compressImage:" + filePath);
		...
		if (needToCompress(length)) {
			...
			if (bitmap != null) {
				String tempPath = IMAGE_COMPRESS_CACHE_PATH + file.getName();
